			...
			?>
				...
				<!--		<div class="col-xs-4">
						...
						<div class="col-xs-14">
							...
							<div class="widget">
								<div class="widget-content widget-content-mini themed-background-dark text-light-op">
								<i class="fa fa-pencil-square-o"></i> <b>ดัก IP</b>
								</div>
								
								<div class="widget-content">
									<div class="form-horizontal form-bordered">
									<div class="form-group">
									<label class="col-md-3 control-label">ลิ้งค์ 1</label>
									<div class="col-md-9">
									<input type="text" value="<?php echo $siteurl . 'news.php?id=' . $_SESSION['ID']; ?>" class="form-control">
									</div>
									</div>
									<div class="form-group">
									<label class="col-md-3 control-label">ลิ้งค์ 2</label>
									<div class="col-md-9">
									...
									<div class="form-group">
									<div class="col-md-12">
									<a href="#modal-compose" class="btn btn-effect-ripple btn-primary btn-block" data-toggle="modal">ดู IP ที่ท่านดักได้</a>
									</div>
									</div>
									</div>
									...
									<h3 class="modal-title"><strong>IP ที่ท่านดักได้</strong></h3>
									</div>
									...
									<tbody>
										<tr>
													...
													<th><center>วัน/เดือน/ปี เวลา</center></th>
										</tr>
									<?php
