...
<div class="block-options pull-left"><a class="btn btn-effect-ripple btn-default" href="tickets.php"><i class="fa fa-chevron-left"></i> กลับไปหน้าอินบล็อก</a> <small><i class="fa fa-spinner fa-2x fa-spin text-success" id="ticketloader" style="display:none"></i></small>
</div>
</div>
...
<button name="newmessage" class="btn btn-effect-ripple btn-primary"><i class="fa fa-share"></i> ตอบกลับ</button>
</form>
</div>
