...
<i class="fa fa-plus"></i> <strong>สมัครสมาชิก</strong>
</h1>
<div id="registerdiv" style="display:inline"></div>
<div class="block animation-fadeInQuickInv">
<div class="block-title">
<div class="block-options pull-right">
<a href="login.php" class="btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="กลับไปหน้าเข้าสู่ระบบ"><i class="fa fa-user"></i></a>
</div>
<h2>สมัครสมาชิก <img id="registerimage" src="img/jquery.easytree/loading.gif" style="display:none"/></h2>
</div>
...
<div class="form-group">
<div class="col-xs-12">
<input type="text" id="email" class="form-control" placeholder="อีเมล์">
</div>
</div>
<div class="form-group">
<div class="col-xs-12">
...
<div class="form-group">
<div class="col-xs-12">
<input type="password" id="rpassword" class="form-control" placeholder="ยืนยันรหัสผ่าน">
</div>
</div>
<div class="form-group">
<div class="col-xs-12">
<input type="text" id="scode" class="form-control" placeholder="เลขกู้คืน 4 หลัก">
</div>
</div>
<div class="form-group">
<div class="col-xs-12">
<input type="text" id="question" class="form-control" placeholder="คำถาม : <?php echo ''.$x1.'+'.$x2.'?'; ?>">
</div>
</div>
<div class="form-group form-actions">
<div class="col-xs-6">
<label class="csscheckbox csscheckbox-primary" data-toggle="tooltip" title="กฎกติกาในการใช้งาน">
<input type="checkbox" name="keep" >
<span></span>
</label>
<a href="<?php echo htmlspecialchars($tos); ?>" target="_blank">กฎกติกาในการใช้งาน</a></a>
</div>
<div class="col-xs-4 text-right">
<button class="btn btn-effect-ripple btn-default" type="button" onclick="register()"><i class="fa fa-plus"></i> สมัครสมาชิก</button>
</div>
</div>
</div>
</div>
