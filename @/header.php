                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                            	<li><i></i></li>
                                <li>
                                    <a href="index.php" <?php if (basename($_SERVER['PHP_SELF']) == "index.php") { ?> class="active" <?php } ?>><i class="fa fa-home sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">แดชบอรด์</span></a>
                                </li>
                                <li>
                                    <a href="phone.php" <?php if (basename($_SERVER['PHP_SELF']) == "phone.php") { ?> class="active" <?php } ?> ><i class="fa fa-phone sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">ยิงเบอร์ (ฟรี)</span></a>
                                </li>
						<?php if ($user->hasMembership($odb)) { ?>
							<li><i></i></li>
						<li>
                                    <a href="stress.php" <?php if (basename($_SERVER['PHP_SELF']) == "stress.php") { ?> class="active" <?php } ?> ><i class="fa fa-bomb sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">โจมตี</span></a>
                                </li>
                           <!--     <li>
                                    <a href="tb.php" <?php if (basename($_SERVER['PHP_SELF']) == "tb.php") { ?> class="active" <?php } ?> ><i class="fa fa-bomb sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">เทสยิงเน็ตตัวเอง (ฟรี)</span></a>
                                </li>-->
						<?php } else { ?>
						...
						?>
					<!--	<li>
                                    <a href="vipstress.php" <?php if (basename($_SERVER['PHP_SELF']) == "vipstress.php") { ?> class="active" <?php } ?> ><i class="fa fa-bomb sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">โจมตี (VIP)</span></a>
                                </li> -->
						<?php
						}
						?>
						<?php if ($user->hasMembership($odb)) { ?>
							<li><i></i></li>
						<li>
                                    <a href="tools.php" <?php if (basename($_SERVER['PHP_SELF']) == "tools.php") { ?> class="active" <?php } ?>><i class="fa fa-book sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">เครื่องมือ</span></a>
                              </li>	
						<?php } ?>
                                <li>
                                    <a href="code.php" <?php if (basename($_SERVER['PHP_SELF']) == "code.php") { ?> class="active" <?php } ?>><i class="fa fa-barcode sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">เติมโค๊ต</span></a>
                              </li>
						<li>
                                    <a href="tickets.php" <?php if (basename($_SERVER['PHP_SELF']) == "tickets.php") { ?> class="active" <?php } ?>><i class="fa fa-envelope sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">แจ้งปัญหา</span></a>
                              </li>
						<li>
                                    <a href="purchase.php" <?php if (basename($_SERVER['PHP_SELF']) == "purchase.php") { ?> class="active" <?php } ?>><i class="fa fa-shopping-cart sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">เช่าแพลน</span></a>
                              </li>
						...
						echo '<li><i></i></li>
								<li>
							<a href="yolo/admin/"><i class="fa fa-dashboard sidebar-nav-icon"></i> หน้าจัดการแอดมิน</a>
							</li>';
						}
						?>
                            </ul>
